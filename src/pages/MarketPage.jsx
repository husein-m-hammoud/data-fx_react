...
const MarketPage = () => {
  ...
  // Format market type for display (capitalize first letter, etc.)
  ...
  return (
    <div className={styles.page}>
      ...
      <main className={styles.main}>
        <MarketBanner title={`Trade ${formattedMarketType}`} description={marketDescription} />
        <BenefitsList marketType={formattedMarketType} />
        <PriceTable marketType={marketType} />
        <EconomicCalendar />
        <MarketFAQ marketType={formattedMarketType} />
      </main>
      <Footer />
    </div>
  );
